...
33. A configured SOCKS5 relay (`TlsQuicSocks5Transport`) is a trusted-but-observing intermediary: it sees every relayed datagram's destination address plus the timing and size of all traffic, though not decrypted QUIC contents.
